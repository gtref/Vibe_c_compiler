...
- **Thread Pool Hardening**: Enforces a strict 1024 thread limit and a 65536 job queue limit with shutdown-aware job rejection to mitigate DoS and prevent memory leaks (v1.5.5).
